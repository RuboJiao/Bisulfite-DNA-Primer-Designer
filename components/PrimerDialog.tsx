...
export const PrimerDialog: React.FC<PrimerDialogProps> = ({
  ...
  const stats = useMemo(() => calculateThermodynamics(sequence), [sequence]);
      ...
      <div className="bg-white rounded-[1.5rem] shadow-2xl w-[780px] max-h-[98vh] overflow-hidden border border-slate-200 flex flex-col animate-in zoom-in duration-200">
        ...
        <div className="bg-slate-50 px-6 py-4 border-b border-slate-200">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[
              ...
              { label: 'Tm 值', val: `${stats.tm.toFixed(1)}°C`, color: 'text-indigo-600' },
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div className="relative group">
            ...
            <textarea 
              value={sequence}
              onChange={(e) => setSequence(e.target.value.toUpperCase().replace(/[^ATCG RYSWKMBDHVN]/g, ''))}
              placeholder="支持简并碱基 (R, Y, S, W, K, M, B, D, H, V, N)"
